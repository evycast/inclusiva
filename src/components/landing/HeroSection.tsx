...
export function HeroSection() {
	return (
		<section className='relative overflow-hidden pt-12 pb-20 lg:pt-20 lg:pb-28'>
			<div className='absolute inset-0 -z-10 bg-gradient-rainbow-soft opacity-30' />
			<div className='container px-4 mx-auto'>
				<div className='flex flex-col lg:flex-row items-center gap-12 lg:gap-20'>
					<div className='flex-[1.2] text-center lg:text-left space-y-8'>
						<Badge
							variant='outline'
							className='px-4 py-2 text-sm rounded-full bg-card/50 border-primary/20 text-primary shadow-friendly animate-in fade-in slide-in-from-bottom-4 duration-700'
						>
						...
						<p className='max-w-2xl mx-auto lg:mx-0 text-xl text-muted-foreground leading-relaxed'>
							Un espacio seguro y moderado donde la comunidad se une. Ofrecé tus servicios, vendé productos, encontrá lo
							que necesitás o sumate a eventos increíbles.
						</p>
					...
					<div className='flex-[0.8] relative w-full max-w-md lg:max-w-full animate-float'>
						...
						<div className='absolute -top-10 -right-10 w-32 h-32 bg-yellow-300 rounded-full opacity-50 -z-10' />
						<div className='absolute -bottom-10 -left-10 w-40 h-40 bg-pink-300 rounded-full opacity-50 -z-10' />
					</div>
				</div>
			</div>
		</section>
