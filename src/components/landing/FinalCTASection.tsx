...
export function FinalCTASection() {
  return (
    <section className='py-24 relative overflow-hidden'>
      ...
      {/* Decorative elements */}
      <div className='absolute top-0 left-0 w-96 h-96 bg-primary/10 rounded-full opacity-40 -translate-x-1/2 -translate-y-1/2' />
      <div className='absolute bottom-0 right-0 w-96 h-96 bg-primary/10 rounded-full opacity-40 translate-x-1/2 translate-y-1/2' />
