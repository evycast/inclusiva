							...
							<div className='flex-1 space-y-8 text-left order-1 md:order-2'>
								<div>
									<div className='space-y-6'>
										<div className='flex flex-col md:flex-row items-center gap-4 '>
											...
											<h3 className='text-3xl md:text-4xl font-bold text-foreground '>Apoyá esta iniciativa</h3>
										</div>
								...
								<div className='pt-4'>
									<Link href='/colaborar' className='inline-block'>
										<Button className='rounded-xl h-14 px-8 text-lg font-bold bg-pink-600 hover:bg-pink-700 text-white shadow-lg shadow-pink-500/20 hover:shadow-pink-500/30 transition-all'>
											Cómo colaborar
